...
description: "KAI is an enterprise AI development platform with 75+ skills for Azure DevOps and Atlassian. Run identical workflows across Claude Code, Copilot CLI, and VS Code Chat."
---
...
<PageHero
  title="Enterprise AI Development Platform"
  subtitle={`For enterprise teams on Azure DevOps and Atlassian. ${stats.totalSkills}+ skills that run identically across Claude Code, GitHub Copilot CLI, and VS Code Chat — from ticket to PR, fully autonomous. Deep AEM specialization built in.`}
/>
