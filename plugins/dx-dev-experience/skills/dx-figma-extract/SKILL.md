...
```
mcp__plugin_dx-dev-experience_figma__get_metadata
  nodeId: <nodeId>
...
```
mcp__plugin_dx-dev-experience_figma__get_design_context
...
```
mcp__plugin_dx-dev-experience_figma__get_variable_defs
