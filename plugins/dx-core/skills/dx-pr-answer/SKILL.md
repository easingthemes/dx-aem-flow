...
when_to_use: "Use when answering open comments on ADO pull requests. Trigger on 'answer PR comments', 'respond to review', 'handle PR feedback', 'reply to reviewer', or 'apply reviewer patch'. Do NOT use to produce a review of a PR (that's dx-pr-review) or to create, commit or push the PR (dx-pr / dx-pr-commit)."
