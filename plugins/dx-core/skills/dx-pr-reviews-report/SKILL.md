...
when_to_use: "Use to generate reports for multiple PR reviews at once. Trigger on 'report all reviews', 'batch PR reports', 'document recent PR reviews', or 'generate reports for reviewed PRs'. Do NOT use for a single PR's report (that's dx-pr-review-report) or to perform the reviews (dx-pr-review-all)."
