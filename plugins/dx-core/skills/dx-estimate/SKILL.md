---
name: dx-estimate
description: "Analyze an Azure DevOps/Jira User Story and produce a structured estimation — understanding, implementation plan, recommended hours/SP, AEM pages affected, and open questions. Posts result as an ADO/Jira comment. Batch mode takes space-separated IDs for parallel estimation. Use when you want an AI-generated estimation for a story. Do NOT use to break a story into child Tasks (that's dx-req-tasks) or to distill its requirements (dx-req)."
