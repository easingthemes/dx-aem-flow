...
| Helper scripts | deterministic bash in `skills/*/scripts/` and `data/lib/` | any `run-tests.sh` or `*.test.sh` under `plugins/` — **discovered** and run in CI on every PR (6 today) |
